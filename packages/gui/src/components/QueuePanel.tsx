          ...
          <div class="mb-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4 text-xs">
                ...
                <Show when={Object.keys(miningState().workersBestPow).length > 0}>
                  <div>
                    <span class="text-text-secondary">Best POW: </span>
                    <span class="font-mono text-accent">
                      {(() => {
                        // Phase 9: Derive from current workers (consistent with MiningPanel)
                        const workerPows = Object.values(miningState().workersBestPow);
